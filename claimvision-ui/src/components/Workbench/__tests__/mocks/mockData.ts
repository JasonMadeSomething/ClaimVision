...
// Mock photos data that matches the structure in WorkbenchLayout.tsx
...
// Mock items data that matches the structure in WorkbenchLayout.tsx
...
// Mock rooms data that matches the structure in WorkbenchLayout.tsx
